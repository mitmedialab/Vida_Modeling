...
def ShapefileFormatter(shpfilepath, datapath,fieldname, writepath):
    ...
    df = pd.read_excel (datapath,index_col ="CodigoRegion") 
...
shppath = './Data/Chile/Shapefiles/chl_admbnda_adm1_bcn2018.shp'
datapath = './Data/Chile/Misc/ShapefileAdding.xlsx'
writepath = './Data/Chile/Shapefiles/Regions_data.shp'
