...
filepath = '/home/jackreid/Documents/School/Research/Space Enabled/Code/Decisions/Auxilary Files/SummaryGraphs/Rio de Janeiro/Nightlights_Median_Weekly/NightlightsRelativeAnomaly_Complete.csv'
...
filename = './Rio de Janeiro/' + 'Median_Weekly_LeastSquares_Stats' +'.csv'
fields = ['Area',
          'T-Value',
          'Norm_P_Value',
          'PrePVal*1000',
