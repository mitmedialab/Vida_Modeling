...
def ShapefileFormatter(shpfilepath, datapath,fieldname, writepath):
    ...
    if fieldname[0] == 'Temporal':
        metrics_raw = []
        metrics_format = []
        for date in list(df.keys()):
            metrics_raw.append(date)
...
metrics = ['Temporal', 'WMob']



shppath = '/home/jackreid/Downloads/temp/geographic_data.shp'
datapath = '/home/jackreid/Documents/School/Research/Space Enabled/Code/Decisions/Data/Santiago/Misc/Mobility_Weekly.xlsx'
writepath = '/home/jackreid/Documents/School/Research/Space Enabled/Code/Decisions/Data/Santiago/Shapefiles/geographic_data.shp'
